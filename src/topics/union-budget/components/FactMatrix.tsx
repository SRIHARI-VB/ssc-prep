          ...
          <div className="overflow-x-auto">
            <table className="text-left min-w-[1200px] w-full">
              <thead className="bg-slate-50 text-xs font-bold uppercase tracking-wider text-slate-500 border-b border-slate-100">
                <tr>
                  <th className="py-3 px-4 min-w-[80px] whitespace-nowrap">Year</th>
                  <th className="py-3 px-4 min-w-[100px] whitespace-nowrap">Category</th>
                  <th className="py-3 px-4 min-w-[160px] whitespace-nowrap">Topic</th>
                  <th className="py-3 px-4 min-w-[310px]">Question</th>
                  <th className="py-3 px-4 min-w-[270px]">Answer</th>
