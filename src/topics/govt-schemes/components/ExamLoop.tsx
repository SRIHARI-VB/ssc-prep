...
function pickFrom(pool: SchemeEntry[]): SchemeEntry {
...
export default function ExamLoop() {
  ...
  const [state, setState] = useState<LoopState>(() => {
    const card = pickFrom(schemesData)
    return { card, options: getOptions(card, schemesData), phase: 'question', score: 0, total: 0 }
  })
